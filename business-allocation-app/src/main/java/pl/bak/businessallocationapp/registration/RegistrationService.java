...
public class RegistrationService {
    ...
    public RegistrationService(UserRepository userRepository, EmailValidator emailValidator, PasswordEncoder passwordEncoder, ModelMapper modelMapper, ConfirmationTokenService confirmationTokenService, EmailSender emailSender) {
    ...
    private String singUp(UserDto userDto) {
        boolean userExist = userRepository.findByEmail(userDto.getEmail())
                .isPresent();
